...
// Map for getting the markers for Waste for money from Cloud Firestore , Learned from the Google Cloud Youtube Video :)


class mp1 extends StatefulWidget {
  const mp1({Key key, @required this.title}) : super(key: key);

  final String title;

  @override
  _mp1State createState() => _mp1State();
}
