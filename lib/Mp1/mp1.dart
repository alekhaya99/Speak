...
// Map for getting the markers for E Waste from Cloud Firestore , Learned from the Google Cloud Youtube Video :)

class Mp2 extends StatefulWidget {
  const Mp2({Key key, @required this.title}) : super(key: key);

  final String title;

  @override
  _Mp2State createState() => _Mp2State();
}

class _Mp2State extends State<Mp2> {
  Stream<QuerySnapshot> _ewaste;
  final Completer<GoogleMapController> _mapController = Completer();

  @override
  void initState() {
    super.initState();
    _ewaste = Firestore.instance
        .collection('ewaste')
        .orderBy('name')
        .snapshots();
  }
